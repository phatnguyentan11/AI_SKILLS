---
name: ef-core
description: Get best practices for Entity Framework Core. Use when working with DbContext, migrations, LINQ queries, change tracking, performance optimization, or testing with EF Core.
...
When reviewing EF Core code, identify issues and suggest improvements that follow these best practices.
