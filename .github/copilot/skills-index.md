...
curated skills, promoted skills, system analysis, business logic, ASP.NET Core, dotnet testing, banking governance, safe Copilot skills, no scripts, no secrets, secure review, testing, docs base, backend, database, release, MCP, Azure DevOps, internal knowledge, deep research.
